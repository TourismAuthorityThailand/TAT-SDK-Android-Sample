package org.tat.sdksample.search;
...
import org.tat.sdksample.detail.DetailActivity;
import org.tat.sdksample.inteface.SearchResultClickListener;
import org.tat.sdksample.model.SearchResults;
...
public class SearchResultActivity extends AppCompatActivity implements SearchResultClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (intent != null) {
            resultList = getIntent().getParcelableExtra(MainActivity.SEARCH_RESULT);
        }
        initInstances();
        setupToolbar();
    }
    ...
    private void initInstances() {
        recyclerView = findViewById(R.id.rcv_search_result);
